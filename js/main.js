...
$(function () {
  ...
  // var owlCategoriesActive = $(".categories-carousel .owl-item.active");
  // var first = owlCategoriesActive[0]; //get first item
  // var last = owlCategoriesActive[owlCategoriesActive.length - 1]; //get last item
